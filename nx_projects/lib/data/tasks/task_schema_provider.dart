...
final projectTaskSchemaProvider = kgqlModelTypeForPersonalDomain(kTaskBaseModelTypeName);
...
final featureTaskSchemaProvider = kgqlModelTypeForPersonalDomain(kFeatureModelTypeName);
