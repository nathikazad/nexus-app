...
final projectTaskSchemaProvider = modelTypeByNameProvider(kTaskBaseModelTypeName);

/// [Bug] subtype — includes `severity` and other Bug-only attributes in KGQL struct resolution.
final bugTaskSchemaProvider = modelTypeByNameProvider(kBugModelTypeName);

/// [Feature] subtype — primary list fetch for feature-shaped tasks.
final featureTaskSchemaProvider = modelTypeByNameProvider(kFeatureModelTypeName);
