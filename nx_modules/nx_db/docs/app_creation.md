...
```
mv lib/domain/<e>/<e>.dart                  ../nx_modules/nx_db/lib/src/kgql/shared/<e>/
mv lib/domain/<e>/<e>_repository.dart       ../nx_modules/nx_db/lib/src/kgql/shared/<e>/
mv lib/data/<e>/<e>_attr_keys.dart          ../nx_modules/nx_db/lib/src/kgql/shared/<e>/
mv lib/data/<e>/<e>_mapper.dart             ../nx_modules/nx_db/lib/src/kgql/shared/<e>/
mv lib/data/<e>/kgql_<e>_repository.dart    ../nx_modules/nx_db/lib/src/kgql/shared/<e>/
```
...
8. **Step 8 — Promote when shared.** When a second app needs an entity,
   ...
   the local copies. See `mobile/nx_modules/nx_db/plans/current/nx_db_app_boundary.md`
