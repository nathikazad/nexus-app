...
class NotesLoginScreen extends ConsumerStatefulWidget {
  const NotesLoginScreen({super.key});

  @override
  ConsumerState<NotesLoginScreen> createState() => _NotesLoginScreenState();
}

class _NotesLoginScreenState extends ConsumerState<NotesLoginScreen> {
