...
import 'package:nx_notes/data/assets/filesystem_document_asset_store.dart';
import 'package:nx_notes/data/assets/memory_document_asset_store.dart';
...
void main() {
  ...
  group('FilesystemDocumentAssetStore contract', () {
    ...
    setUp(() async {
      directory = await Directory.systemTemp.createTemp('nx_notes_assets_');
    });
    tearDown(() async {
