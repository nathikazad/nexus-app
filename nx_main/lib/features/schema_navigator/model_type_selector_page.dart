...
class ModelTypeSelectorPage extends ConsumerStatefulWidget {
  const ModelTypeSelectorPage({super.key});

  @override
  ConsumerState<ModelTypeSelectorPage> createState() =>
      _ModelTypeSelectorPageState();
}

class _ModelTypeSelectorPageState extends ConsumerState<ModelTypeSelectorPage> {
  ...
  void _selectModelType(SchemaModelType modelType) {
