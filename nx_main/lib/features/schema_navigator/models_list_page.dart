...
class ModelsListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final modelsAsync = ref.watch(schemaModelsProvider(modelTypeId));
    final modelTypeAsync = ref.watch(schemaModelTypeProvider(modelTypeId));
