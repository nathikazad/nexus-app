# `nx_docs` implementation plan

This plan builds `nx_docs` in thin vertical slices. The goal is to get
...
flutter create --template=app --org com.nexus --platforms ios,android,web nx_docs
```
