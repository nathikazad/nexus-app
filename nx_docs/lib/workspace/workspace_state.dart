...
class MobileWorkspaceNotifier extends Notifier<MobileWorkspaceState> {
  @override
  MobileWorkspaceState build() => const MobileWorkspaceState();
...
final mobileWorkspaceProvider =
    NotifierProvider<MobileWorkspaceNotifier, MobileWorkspaceState>(
      MobileWorkspaceNotifier.new,
    );
