...
class DocsSettingsButton extends ConsumerWidget {
  const DocsSettingsButton({this.onSyncNow, super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return IconButton(
      ...
      onPressed: () {
        showDialog<void>(
          context: context,
          builder: (context) => _DocsSettingsDialog(
            offlineEnabled: offlineEnabled,
            onSyncNow:
                onSyncNow ??
                () async {
                  await ref.read(libraryRefreshProvider)();
                },
          ),
        );
      },
...
class _DocsSettingsDialog extends ConsumerStatefulWidget {
  const _DocsSettingsDialog({
  ...
  @override
  ConsumerState<_DocsSettingsDialog> createState() =>
      _DocsSettingsDialogState();
}

class _DocsSettingsDialogState extends ConsumerState<_DocsSettingsDialog> {
