...
import 'package:nx_docs/sync/sync_models.dart' as notes;
...
/// Adapts the typed document database outbox to the shared delivery runtime.
final class DocumentOutboxStoreAdapter implements offline.OutboxStore {
  const DocumentOutboxStoreAdapter({
