...
import 'package:nx_docs/documents/assets/document_image_file_reader_stub.dart'
    if (dart.library.io) 'package:nx_docs/documents/assets/document_image_file_reader_io.dart';
...
void _debugDocumentImage(String message) {
  debugPrint('[nx_docs image] $message');
}
