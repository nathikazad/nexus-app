...
import 'package:nx_docs/data/document/document_image_file_reader_stub.dart'
    if (dart.library.io) 'package:nx_docs/data/document/document_image_file_reader_io.dart';
