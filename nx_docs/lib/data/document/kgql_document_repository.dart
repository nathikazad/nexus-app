...
import 'package:nx_docs/data/document/document_mapper.dart';
...
import 'package:nx_docs/domain/tags/tag_system.dart' as domain_tags;
...
class KgqlDocumentRepository implements DocumentRepository {
  ...
  Future<NxDocument?> getById(int id) async {
    ...
    if (kDebugMode) {
      debugPrintStack(
        label:
            '[nx_docs repository] getById start '
    ...
    if (model == null) {
      if (kDebugMode) {
        debugPrint(
          '[nx_docs repository] getById finish '
