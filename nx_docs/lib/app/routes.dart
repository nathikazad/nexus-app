...
class DocsInitializingPage extends StatelessWidget {
  const DocsInitializingPage({super.key});
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: <RouteBase>[
      GoRoute(
        path: '/login',
        builder: (context, state) => const DocsLoginPage(),
      ),
      GoRoute(
        path: '/initializing',
        builder: (context, state) => const DocsInitializingPage(),
      ),
