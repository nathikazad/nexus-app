...
import 'package:nx_time/features/log_tags/log_tag_system_form_page.dart';

/// Reference Screen 6: Tag Systems.
class LogTagsPage extends ConsumerWidget {
  const LogTagsPage({super.key, this.embedded = false});
  ...
  void _openForm(BuildContext context, int? id) {
    Navigator.of(context).push<void>(
      MaterialPageRoute<void>(
        builder: (_) => LogTagSystemFormPage(tagSystemId: id),
      ),
    );
  }
}
