...
import 'package:nx_time/data/fake_today_repository.dart';
import 'package:nx_time/data/today_repository.dart';

/// Logged-in user without hitting the network; keeps [FakeTodayRepository] for stable screenshots.
...
List<Override> get screenshotAuthOverrides => [
      ...
      todayRepositoryProvider.overrideWith((ref) => FakeTodayRepository()),
    ];
