...
import 'package:nx_cards/tutor/openai_api_key.dart';
import 'package:nx_cards/tutor/voice_tutor.dart';
...
class VoiceStudySessionPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VoiceStudySessionPage> createState() =>
      _VoiceStudySessionPageState();
}
...
class _VoiceStudySessionPageState extends ConsumerState<VoiceStudySessionPage> {
  ...
  void initState() {
    super.initState();
    controller = VoiceTutorController(
      session: LiveAgentSession(transport: OpenAiRealtimeTransport()),
      repository: ref.read(cardLibraryProvider),
