...
import 'package:nx_cooking/features/cooking_plan/cooking_plan_view_page.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return CookingPlanViewPage(planId: id);
        },
      ),
      GoRoute(
        path: '/task/:id',
        redirect: (context, state) => '/plan/${state.pathParameters['id']}',
      ),
      GoRoute(
        path: '/recipe/:id',
        builder: (context, state) {
