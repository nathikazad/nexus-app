...
- Original import sources remain in `assets/` for provenance, but are no longer
  bundled into the application. The separate [Story Creator repository](<../../story_creator/README.md>) holds story sources, generation tools, skills, and private outputs.
