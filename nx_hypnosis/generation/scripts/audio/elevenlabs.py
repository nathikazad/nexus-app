...
DEFAULT_VOICE = "Njn5qkKYqadqLJNsoRoL"  # Approved female voice
...
def main():
    ...
    parser.add_argument("--speaker-boost", action=argparse.BooleanOptionalAction, default=False)
    ...
    output = args.output or BASE / "outputs" / (
    ...
    try:
        ...
        hints = {
            401: "Check credits, API key validity, and its permissions; quota errors can also return 401.",
