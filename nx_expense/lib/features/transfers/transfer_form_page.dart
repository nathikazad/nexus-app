...
import 'package:nx_expense/features/expense/widgets/model_attribute_form_field.dart';
...
class _TransferFormScreenState extends ConsumerState<TransferFormScreen> {
  ...
  void _seedFromModel(ModelTypeView schema, Transfer m) {
    _name.text = m.name;
  ...
  void _seedFromExpense(
    Expense expense,
    ModelTypeView expenseSchema,
    ModelTypeView transferSchema,
  ) {
      ...
      if (widget.prefillFromExpenseId != null && widget.transferId == null) {
        ...
        try {
          await ref
              ...
              .deleteById(widget.prefillFromExpenseId!);
